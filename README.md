...
```bash
# Inspector: pass the object ID (Workbench-style)
node dist/index.js stripe inspect-object pi_...
node dist/index.js stripe inspect-object cus_... --related

# API Explorer / Shell: GET, POST, or DELETE (sandbox / test mode)
node dist/index.js stripe api-request pi_...
node dist/index.js stripe api-request /v1/customers/cus_... --method POST \
